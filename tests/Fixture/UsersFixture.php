...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nickname' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'ninkname_UNIQUE' => ['type' => 'unique', 'columns' => ['nickname'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-01-19 05:16:21',
                'modified' => '2020-01-19 05:16:21',
            ],
        ];
        parent::init();
    }
